...
if __name__=='__main__':
	...
	llist=LinkedList()
while(1):
	inp=input('Please enter your choice:\n 1.insert 2.delete 3.count, 4.sum, 5.print nodes, 6.find maximum element, 7.Search element, 8.sort the linked list in ascending order,9.sort the linked list in descending order , 10. check if linked list is sorted, 11. remove duplicates unsorted ,12. remove duplicates sorted ,13.exit\n')
	if(inp=='1'):
